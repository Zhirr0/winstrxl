...
const MenuSection = () => {
  ...
  useGSAP(() => {
    const headers = menuSection.current.querySelectorAll(".menu-animated-headers");
  ...
  useEffect(() => {
    const handleMenuToggle = (e) => {
      ...
      if (isActive) {
        ...
        .to(headersSplitRef.current.chars, {
          xPercent: 0,
          scaleX: 1,
          duration: 0.6,
          stagger: 0.02,
        ...
        .to(fromBottomSplitRef.current.chars, {
          yPercent: 0,
          duration: 0.5,
          rotateY: 0,
          stagger: 0.01,
